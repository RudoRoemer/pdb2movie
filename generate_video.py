        ...
        for cut in cutlist:
            for mode in modelist:
                for sign in signals:
                    ...
                    command = ['ffmpeg', '-pattern_type', 'glob', '-i', folder+'/'+tmpfolder+'tmp/*.ppm', '-c:v', 'mpeg2video', '-pix_fmt', 'yuv420p', '-me_method', 'epzs', '-threads', '4', '-r', '30.000030', '-g', '45', '-bf', '2', '-trellis', '2', '-s', '1280x960', '-b', '6000k', filename]
                    print(command)
