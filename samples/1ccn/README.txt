...
> python pdb2movie.py 1ccn.pdb --combi --confs 10 --freq 50 --modes 7 8 --ecuts 2.0 --res 1920 1080 --multiple --videocodec mp4 --drawingengine pymol

This produces the .mp4 movies given in samples/1ccn. For .mov movies, do

> python pdb2movie.py 1ccn.pdb --combi --confs 10 --freq 50 --modes 7 8 --ecuts 2.0 --res 1920 1080 --multiple --videocodec hevc --drawingengine pymol
